...
(1, 'http://bookingsystem.com', 'Hitech city', 'Hyderabad', 'Telangana', 'India', '500090', '1234567891', '+040 - 00 333 000', '6756666', 'vehiclebooking@contact.com', 'in', 'Km', 'Enable', 'Enable', '5:00', '20:00', '20:00', '5:00', 'Yellow', 'Sendmail', 'abcd', 'http://yoururl.com', '© Digi Advanced Cab Booking System 2018. All rights reserved.', '', 1, 1, 1, 1, 0, 'mm/dd/YYYY', 'US/Alaska', '<script type=\"text/javascript\"> function init_map(){var myOptions = {zoom:17,center:new google.maps.LatLng(17.45143909381126,78.38544047965388),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById(\"gmap_canvas\"), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(17.45143909381126, 78.38544047965388)});infowindow = new google.maps.InfoWindow({content:\"<b>abcd</b><br/>Plot No.16, 3rd Floor, Triveni Towers Silicon Valley, 100 Feet Road, Madhapur, Hitech City, Hyderabad, Telangana 500081, India<br/>500081 hyderabad,telangana\" });google.maps.event.addListener(marker, \"click\", function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, \'load\', init_map);</script>                                                             ', 'site_logo.png', 'USD', 0, '$', 'Booking System', 'en', 'Enable', '25th Street, San Francisco, CA, United Statez', '19th Street, San Francisco, CA, United Statez', 'Google API Key', 'fevicon.ico', '91', 'Yes', 20.00, 'Yes', 'Facebook App ID', 'Facebook App Secret', 'Google Client ID', 'Google Client Secret');
