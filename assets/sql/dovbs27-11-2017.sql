...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 27, 2017 at 06:28 AM
...
CREATE TABLE `vbs_bookings` (
  ...
  `payment_type` enum('cash','paypal','credit card') NOT NULL DEFAULT 'cash',
...
(1, '::1', 'customer@gmail.com', 1511758183),
(2, '::1', 'testcustomer@gmail.com', 1511758190);
...
INSERT INTO `vbs_site_settings` (`id`, `site_name`, `address`, `city`, `state`, `country`, `zip`, `phone`, `land_line`, `fax`, `portal_email`, `site_country`, `distance_type`, `waiting_time`, `airports_status`, `day_start_time`, `day_end_time`, `night_start_time`, `night_end_time`, `site_theme`, `email_type`, `design_by`, `url_for_design_by`, `rights_reserved_content`, `map`, `paypal`, `cash`, `credit`, `date_formats`, `time_zone`, `contact_map`, `site_logo`, `site_currency`, `driver_charge_night`, `currency_symbol`, `site_title`, `default_language`, `language_dropdown`, `pick_point_placeholder`, `drop_point_placeholder`, `google_api_key`, `fevicon`, `country_code`, `apply_tax`, `tax_amount`, `sms_notification`, `facebook_app_id`, `facebook_app_secret`, `google_client_id`, `google_client_secret`) VALUES
(1, 'your My', 'Hitech city', 'Hyderabad', 'Telangana', 'India', '500090', '1234567891', '+040 - 00 333 000', '6756666', 'admin@admin.com', 'in', 'Km', 'Enable', 'Enable', '5:00', '20:00', '20:00', '5:00', 'Yellow', 'Sendmail', 'abcd', 'http://yoururl.com', '© Digi Advanced Cab Booking System 2017. All rights reserved.', '', 1, 1, 0, 'dd/mm/YYYY', 'Asia/Calcutta', '<script type=\"text/javascript\"> function init_map(){var myOptions = {zoom:17,center:new google.maps.LatLng(17.45143909381126,78.38544047965388),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById(\"gmap_canvas\"), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(17.45143909381126, 78.38544047965388)});infowindow = new google.maps.InfoWindow({content:\"<b>abcd</b><br/>Plot No.16, 3rd Floor, Triveni Towers Silicon Valley, 100 Feet Road, Madhapur, Hitech City, Hyderabad, Telangana 500081, India<br/>500081 hyderabad,telangana\" });google.maps.event.addListener(marker, \"click\", function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, \'load\', init_map);</script>                                                             ', 'site_logo_1.jpg', 'USD', 0, '$', 'Booking System', 'en', 'Enable', '25th Street, San Francisco, CA, United Statez', '19th Street, San Francisco, CA, United Statez', 'AIzaSyDO_lURb8GWwWr1uf2oIlH9Rx1NL9i2gWg', 'fevicon.ico', NULL, 'Yes', 20.00, 'Yes', '514671242257849', '5d73aa9a3482466487b688a3ce05cc51', '979191856851-m9o17a53f19uubgoulb4t26errgjj00u.apps.googleusercontent.com', 'WDGteCscn4gNyhncbCLCgJtx');
...
(1, '127.0.0.1', 'Administrator', '$2y$08$xIoOEWzHjeuyHWy1Gs9B8eea9MRWmdEakrKfZ8cXyystWgappnBsW', '', 'admin@admin.com', '', 'W3EONGQDtY2XqdEjE33niO6d4a4c02cf134c3769', 1510830309, 'SB8ZINiw03EfB52P7zeYUu', 1268889823, 1511760091, 1, 'Admin', 'istrator', '9898989898', 'Art-Student.jpg', '2014-06-22', NULL),
...
--
ALTER TABLE `vbs_users`
  MODIFY `id` int(25) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
